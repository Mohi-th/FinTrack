  ...
  return (
    <Card className="animate-fade-in-up" padding="none">
      ...
      <div className="flex flex-col">
        {recent.map(tx => (
          <div key={tx.id} className="flex items-center gap-3 px-5 py-3 transition-colors duration-150 border-b border-glass-border last:border-b-0 hover:bg-bg-hover max-[360px]:px-4 max-[360px]:gap-2">
